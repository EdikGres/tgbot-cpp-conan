...
//
////                msg = bot.getApi().sendVideo(message->from->id, InputFile::fromFile("/home/edik/Загрузки/tg/Промо ролик.MP4", "video/mp4"), true, 0, 0, 0, "", "test");
//
//                    msg = bot.getApi().sendDocument(message->from->id, InputFile::fromFile("/home/edik/Загрузки/Telegram Desktop/Баннер.png", "image/png"), "", "test");
//                db.addFile("gmp-banner", msg->document->fileId);
